...
public class MapServerComp implements ModuleInitProc {
    ...
    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(MapServer.component_conf);
      mgr.registerFactory(prop, new MapServer(), new MapServer());
...
//      }
    ...
    public static void main(String[] args) {
        ...
        MapServerComp init = new MapServerComp();
